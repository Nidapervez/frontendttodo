        ...
        <div className="w-full max-w-md animate-slideInUp">
          ...
          <div className="bg-white border border-gray-200/60 rounded-2xl p-10 shadow-lg" style={{boxShadow: '0 12px 28px rgba(99, 102, 241, 0.12)'}}>
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600 text-base font-light leading-relaxed">Create your TaskAI account</p>
            </div>

            {/* Error Message */}
            {error && (
              <div className="mb-6 p-5 rounded-lg bg-red-50 border border-red-200/60 animate-slideInDown" style={{boxShadow: '0 4px 12px rgba(239, 68, 68, 0.08)'}}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="group">
                ...
                <p className="text-xs text-gray-500 mt-2 leading-relaxed">At least 6 characters</p>
              </div>

              {/* Confirm Password Input */}
              <div className="group">
                <label htmlFor="confirm-password" className="block text-sm font-semibold text-gray-700 mb-3 tracking-tight">
                  Confirm Password
                </label>
                <div className="relative">
                  <input
